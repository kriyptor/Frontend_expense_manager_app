...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    fetchExpenses(storedUserId, 1, paginationInfo.itemsPerPage);
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      fetchExpenses(userId, paginationInfo.currentPage, paginationInfo.itemsPerPage);
  ...
  const handlePageChange = (pageNumber) => {
    fetchExpenses(userId, pageNumber, paginationInfo.itemsPerPage);
  };

  // Handle rows per page change
  const handleItemsPerPageChange = (value) => {
    if (value > 0) {
      fetchExpenses(userId, 1, value); // Reset to first page when changing items per page
    }
  };
